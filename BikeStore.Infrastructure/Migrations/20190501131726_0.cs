    ...
    public partial class _0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdxForkNotoificationImage = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    IdxForkNotification = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    Size = table.Column<long>(nullable: false),
                    Content = table.Column<byte[]>(nullable: true),
                    ForkNotificationIdxForkNotfication = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForkNotficationImages", x => x.IdxForkNotoificationImage);
                    table.ForeignKey(
                        name: "FK_ForkNotficationImages_ForksNotifications_ForkNotificationId~",
                        column: x => x.ForkNotificationIdxForkNotfication,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForkNotficationImages_ForkNotificationIdxForkNotfication",
                table: "ForkNotficationImages",
                column: "ForkNotificationIdxForkNotfication");
